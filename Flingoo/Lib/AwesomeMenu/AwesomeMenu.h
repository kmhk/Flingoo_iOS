...
@property (nonatomic, strong) UILabel *lblTitleChat;
@property (nonatomic, strong) UILabel *lblTitleGift;
@property (nonatomic, strong) UILabel *lblTitleFriend;
@property (nonatomic, strong) UILabel *lblTitleFav;
@property (nonatomic, strong) UILabel *lblTitleRepo;
