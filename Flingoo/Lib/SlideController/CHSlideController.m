...
#define kSwipeAnimationTime 0.3
...
-(void)showSlidingViewAnimated:(BOOL)animated
{
    ...
    if (animated) {
        ...
        [UIView animateWithDuration:kSwipeAnimationTime delay:0 options:UIViewAnimationOptionAllowAnimatedContent animations:^{
            ...
            //hemalasanka
            UIView *myView = self.leftStaticViewController.view;
            CALayer *layer = myView.layer;
            CATransform3D rotationAndPerspectiveTransform = CATransform3DIdentity;
            rotationAndPerspectiveTransform.m34 = 1.0 / -500;
            
            rotationAndPerspectiveTransform = CATransform3DRotate(rotationAndPerspectiveTransform, -40.0f * M_PI / 180.0f, 0.0f, 1.0f, 0.0f);
            
            layer.transform = rotationAndPerspectiveTransform;
//            self.leftStaticViewController.view.alpha=1.0;
...
-(void)showLeftStaticView:(BOOL)animated
{
    ...
    if (animated) {
        [UIView animateWithDuration:kSwipeAnimationTime delay:0 options:UIViewAnimationOptionAllowAnimatedContent animations:^{
            ...
            layer.transform = rotationAndPerspectiveTransform;
//            self.leftStaticViewController.view.alpha=1.0+xx-0.4;
...
- (void) handlePanGesture:(UIPanGestureRecognizer *)recognizer
{
    ...
    switch ( recognizer.state )
    {
        ...
        case UIGestureRecognizerStateChanged:
        {
            ...
            xx=(_slidingView.frame.origin.x-265)/265 * 40.0f * M_PI / 180.0f;
            
             rotationAndPerspectiveTransform = CATransform3DRotate(rotationAndPerspectiveTransform, xx, 0.0f, 1.0f, 0.0f);
            layer.transform = rotationAndPerspectiveTransform;
//            self.leftStaticViewController.view.alpha=1.0+xx-0.4;
//            float temp=1.0+xx-0.4;
//            NSLog(@"temptemp %f",temp);
            //////////////////////////
