...
@interface FLFFriendsViewController() <UITableViewDataSource, UITableViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
...
@implementation FLFFriendsViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        self.tabBarItem.image = [UIImage imageNamed:@"fav_friends.png"];
...
- (void)refresh:(UIRefreshControl *)refreshControl {
    NSLog(@"refreshControlrefreshControl");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self cellSelect:(FLOtherProfile *)[friendArr objectAtIndex:[indexPath row]]];
}
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.row==0){
        [cell hideStatus];
        cell.profilePicImageView.image = [UIImage imageNamed:@"fv_addFriend.png"];
        cell.profileNameLabel.text = @"Add Friend";
    }else{
        
        FLOtherProfile *profileObj=[[FLOtherProfile alloc] init];
        profileObj=(FLOtherProfile *)[friendArr objectAtIndex:indexPath.row-1];
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    {
     [self cellSelect:(FLOtherProfile *)[friendArr objectAtIndex:[indexPath row]-1]];
    }
...
-(IBAction) friendRequestsPressed:(id)sender;{
...
{
    NSLog(@"profileFriendshipFriendListResult call");
    [HUD hide:YES];
