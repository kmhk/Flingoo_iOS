//
//  FLChatGroupBubbleViewController.m
//  Flingoo
//
...
@interface FLChatGroupBubbleViewController ()<UITextFieldDelegate, UITableViewDataSource, UITableViewDelegate, UIActionSheetDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate>
...
@implementation FLChatGroupBubbleViewController
...
- (void) goBack
{
    if ([self.navigationController.viewControllers[0] isKindOfClass:[FLChatGroupBubbleViewController class]]) {//came from othere view
