...
@interface FLChatScreenViewController ()<UITextFieldDelegate, UITableViewDataSource, UITableViewDelegate, UIActionSheetDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate>
...
@implementation FLChatScreenViewController
...
- (void) goBack
{
    if ([self.navigationController.viewControllers[0] isKindOfClass:[FLChatScreenViewController class]]) {//came from othere view
