...
@interface FLProfileVisitorsViewController() <UITableViewDataSource, UITableViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
...
@implementation FLProfileVisitorsViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        self.tabBarItem.title = @"Profile Visitors";
        self.tabBarItem.image = [UIImage imageNamed:@"pv_visitors.png"];
    }
    return self;
}
...
- (void)viewDidLoad
{
    ...
    self.navigationController.navigationBar.topItem.title = @"Profile Visitors";
...
//    {
        ...
        [webService profileVisitors:self];
//    }
}
...
-(void)cellSelect:(FLOtherProfile *)profileObj
{
    if(IS_IPAD){
        ...
        FLMFDetailsViewController *detailViewCon=[[FLMFDetailsViewController alloc] initWithNibName:@"FLMFDetailsViewController"
                                                                                             bundle:nil
                                                                                            profile:@"OtherProfile"
                                                                                     withProfileObj:profileObj];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    return  [FLGlobalSettings sharedInstance].profileVisitorsArr.count;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    profileObj=(FLOtherProfile *)[[FLGlobalSettings sharedInstance].profileVisitorsArr objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    FLOtherProfile *clickedProfile=(FLOtherProfile *)[[FLGlobalSettings sharedInstance].profileVisitorsArr objectAtIndex:[indexPath row]];
    FLWebServiceApi *webServiceApi=[[FLWebServiceApi alloc] init];
