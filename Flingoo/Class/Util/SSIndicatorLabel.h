...
/**
 A view that indicates completion of the activity to the user. (read-only)
 */
@property (nonatomic, retain, readonly) UIImageView *completedImageView;
...
/**
 A Boolean value that determines whether the view is completed loading.
