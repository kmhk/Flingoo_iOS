//
//  FLAdvancedSearchResultsViewController.m
//  Flingoo
//
...
@interface FLAdvancedSearchResultsViewController () <UITableViewDataSource, UITableViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
...
@implementation FLAdvancedSearchResultsViewController

-(id) initWithSearchResultsArray:(NSArray *) resultsArray;{
    self = [self initWithNibName:(IS_IPAD)?@"FLAdvancedSearchResultsViewController-iPad":((IS_IPHONE5)?@"FLAdvancedSearchResultsViewController-568h":@"FLAdvancedSearchResultsViewController") bundle:nil];
    if(self){
        _searchResultsArray = resultsArray;
    }
    return self;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    profileObj=(FLOtherProfile *)[self.searchResultsArray objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    FLOtherProfile *clickedProfile=(FLOtherProfile *)[self.searchResultsArray objectAtIndex:[indexPath row]];
    FLWebServiceApi *webServiceApi=[[FLWebServiceApi alloc] init];
